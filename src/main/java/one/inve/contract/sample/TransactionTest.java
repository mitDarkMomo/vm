...
public class TransactionTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        test.callFunc(contractAddr, "testBlockNum", "3b9aca00", "1e8480", "00", testBlockNumAbi);
//        test.callFunc(contractAddr, "balanceOf", "3b9aca00", "0186a0", "00", erc20BalanceOfAbi);
    ...
    public byte[] createContract(String _bytecode, String _args) throws IOException {
        ...
        byte[] gasLimit= Hex.decode("1e8480");  //033450 => 210000; 061a80 => 400000; 1e8480 => 2000000; 0186a0 => 100000
